        ...
        <MainLayout>
            <div className="min-h-screen text-white">
                ...
                <form className=" mx-10 md:mx-96 mt-10">
                    <div className="mb-6">
                        <label for="countries" class="block mb-2 text-sm font-medium text-white">Select your Kiltro restobar</label>
                    ...
                    <div className="mb-6">
                        <label for="email" className="block mb-2 text-sm font-medium text-white">Your phone</label>
                    ...
                    <div className="mb-6"> 
                        ...
                        <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-main focus:border-primary-main dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-main dark:focus:border-primary-main" placeholder="Leave a comment..."></textarea>
                    </div>
                    <button type="submit" className="bg-primary-dark w-full transition duration-200 hover:bg-primary-darkest py-4 px-10 text-white">Submit</button>
                </form>
            </div>
